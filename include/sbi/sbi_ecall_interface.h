...
#ifdef APLIC_COURIER_PENDING_QUEUE_TEST

/*
 * NOTE: This patch adds a temporary vendor extension for bring-up.
 * It is expected to be replaced by trap-and-emulate of APLIC MMIO.
 */

/* Vendor extension base range is defined by the SBI spec. Choose a private ID. */
#define SBI_EXT_RISCSTAR_VIRQ			0x0900524d

/* Function IDs for SBI_EXT_RISCSTAR_VIRQ */
#define SBI_EXT_RISCSTAR_VIRQ_POP		0
#define SBI_EXT_VENDOR_VIRQ_COMPLETE		1

/*
 * SBI_EXT_RISCSTAR_VIRQ_POP
 * Returns:
